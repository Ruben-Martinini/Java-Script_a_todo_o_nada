...
if(posicionEnLaCarrera === 1){
    resultado ='FELICITACIONES, SALISTE 1RO';
   
}else if(posicionEnLaCarrera === 2) {
    resultado = 'Te falto poquito para ganar';
   
}else if(posicionEnLaCarrera === 3) {
    resultado = 'Sos un orgullo para tu familia';
   
}else if(posicionEnLaCarrera > 3 && posicionEnLaCarrera < 7 ) {
    resultado = 'Volvé a tu casa';
   
}else{
    resultado = 'No tires fruta';
}
